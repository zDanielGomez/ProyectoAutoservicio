...
def validar_email(value):
    try:
        validate_email(value)  # Valida el correo ingresado por el usuario
...
class Marca(models.Model):
    ...
    nombre = models.CharField(max_length=50, verbose_name="Nombre")
    estado = models.CharField(max_length=50,choices=Estadosopciones, default='Activo')
...
class Cliente(models.Model):
    ...
    tipo_documento = models.CharField(max_length=3, choices=TipoDocumento.choices, default=TipoDocumento.CC, verbose_name="Tipo de documento")
    cc_cliente = models.PositiveIntegerField(unique=True, validators=[validar_numero_documento],verbose_name="Numero Documento")
