        ...
        tablaproductos = $('#tablaproductos').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function (data, type, row) {
                        return '<input type="number" value="' + parseFloat(data).toFixed(2) + '" class="form-control" min="0" oninput="if(this.value < 0) this.value = 0" onchange="actualizarData(this, ' + row.id + ')">';
                    }
                },
                {
                    targets: [-2],
